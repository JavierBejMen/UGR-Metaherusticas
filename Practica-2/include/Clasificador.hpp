...
public:
	...
	void valida5f(string name, string nameAlg, vector<double> (* algorithim)(const Datos&));
	void valida5f(string name);
	double funcionObjetivo5fPrb();
	double funcionObjetivo5fEntr();
...
private:
	...
	Utils::resultado valida5fresult();
