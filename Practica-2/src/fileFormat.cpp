...
int main(int argc, char * argv[])
{
	...
	*/
	...
	cout<<"data: "<<datos.size()<<"    0:"<<n_class_0<<"    1:"<<n_class_1<<endl;
	for(int i=0; i < 5; ++i){
		aux.clear();
		path ="data/5f/"+ relation + "/" + relation + to_string(i) + ".data";
		...
		{
			if(datos[j][nAttr-1] == 0 && in_n_class_0 < n_class_0/5)
			{
				aux.push_back(datos[j]);
				++in_n_class_0;
			...
			else if(datos[j][nAttr-1] == 1 && in_n_class_1 < n_class_1/5)
			{
				aux.push_back(datos[j]);
				++in_n_class_1;
				datos.erase(datos.begin()+j);
		...
		cout<<"Aux "<<i<<": "<<aux.size()<<"  0:"<<in_n_class_0<<"    1:"<<in_n_class_1<<endl;
		}
	...
	cout<<"Aux 4: "<<datos.size()<<"    0:"<<n_class_0-in_n_class_0*4<<"    1:"<<n_class_1-in_n_class_1*4<<endl;
